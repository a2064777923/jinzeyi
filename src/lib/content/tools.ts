...
export const toolPages: ToolContent[] = [
  ...
  },
  {
    ...
    seo: createLocalizedSeo({
      ...
      description: '输入参与者出生资料和日期范围，筛出更适合结婚、搬家、开业、上学、签约等安排的日期。',
      h1: '推荐日期',
      deck: '把更合适的日子排到前面，理由和提醒一起展开。',
      keywords: ['推荐日期', '个性化择日', '结婚择日', '搬家择日', '开业择日', '上学择日'],
    }),
    body: '适合结婚、搬家、开业、上学、签约等需要多方确认的日期。一张卡同时呈现黄历基调、事项匹配、生肖冲煞、八字五行和可用吉时，方便比较取舍。',
    faq: [
      {
