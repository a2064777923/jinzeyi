...
const fallbackGlossary: Partial<Record<GlossaryKey, Omit<GlossaryEntry, 'key'>>> = {
  ...
  yiJi: {
    ...
    detail: '宜忌要對應你的真實場景。凶日仍可能有宜事，代表小事或特定事項可參考，但婚嫁、入宅、開業等大事還應多看一層吉日、時辰和沖煞。',
    href: '/jieri',
    linkLabel: '按事情類型篩吉日',
  },
  luckyHour: {
  ...
  fiveElements: {
    ...
    detail: '五行分佈適合作為入門視角，不應直接推出命運結論。四柱和五行排出後，才適合接更細的解讀。',
    href: '/tools/bazi',
    linkLabel: '八字五行',
  },
  fourPillars: {
    ...
    detail: '四柱把出生時間拆成四個時間層次。一般會以日柱作為中心，搭配其他柱和五行分佈一起讀；本站目前只做基礎文化參考。',
    href: '/tools/bazi',
    linkLabel: '輸入出生資料排四柱',
  },
  mingCaiWei: {
  ...
  qiKou: {
    ...
    detail: '談氣口時，現實問題最重要：門能不能順利打開，玄關是否明亮，鞋物是否絆腳，通風是否舒服。這比堆擺件更重要。',
